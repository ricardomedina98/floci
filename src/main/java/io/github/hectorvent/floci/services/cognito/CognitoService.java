...
public class CognitoService {
    ...
    public CognitoUser signUp(String clientId, String username, String password, Map<String, String> attributes) {
        ...
        //
        // Both nullable only in legacy tests that pre-date the verification
        // subsystem. Production: @Inject always provides both, this branch
        // is never skipped.
     ...
     * (AWS-faithful — Cognito rejects re-confirmation).
     */
    public void confirmSignUp(String clientId, String username, String confirmationCode) {
        ...
        // Production: @Inject always provides verificationCodes, this branch is never taken.
