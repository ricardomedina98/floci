...
class CognitoContractTest {
    ...
    void signUp_responseShapeMatchesAws() throws Exception {
        ...
        assertEquals(false, response.path("UserConfirmed").asBoolean(true), "UserConfirmed");
        assertEquals(notNullValue().toString(),
                response.path("UserSub").asText().isEmpty() ? null : notNullValue().toString(),
                "UserSub present");
        ...
        assertEquals(false, cdd.path("Destination").asText().isEmpty(), "Destination present");
    }
    ...
    void confirmSignUp_wrongCode_returnsCodeMismatchException() throws Exception {
        ...
        assertEquals(true, errorType.contains("CodeMismatchException"),
